...
<script>
    $(document).ready(function () {
        ...
        $("#container").on("click",".submitor",function(){
            ...
            var workName = $("#container").attr("ExamId");
...
<ul id="container" selects="${selects}" judges="${judges}" subs="${subs}" ExamId="${workid}">
    <li><button class='submitor' action="${pageContext.request.contextPath}/page/postExam">提交</button></li>
</ul>
</body>
</html>
