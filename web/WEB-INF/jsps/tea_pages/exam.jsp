...
<script>
    $(document).ready(function () {
        ...
        $("#workContainer").on("click",".editor",function(){
            ...
            window.location.replace("turn?target=tea_pages/ExamEditor");
        })
        $("#workContainer").on("click",".pageTrigger",function(){
            // var courseId = $(this).parent().parent().attr("corr_courseID");
            // window.location.replace("course?courseId="+courseId);
            var name = $(this).attr("workname");
            window.location.replace("examAnalysis?workId="+name);
        })
    ...
    <div class="container over-hide">
        <div class="row pd-t40">
            <h3 class="title text-center">
                <p class="mg-0"><span class="title-top">发布考试</span></p>
                <br><br>
            </h3>

            <div class="col-xs-12 col-sm-9 over-hide">
                <div class="row">
                    <ul class="ad_li1" id="workContainer" works="${exams.toString()}">

                        <li class="col-xs-12 col-sm-4">
                            <div class="li-inner">
                                <p><img src="../static/images/tianjia.svg" alt="添加课程"> </p>
                                <h3><button class="editor">添加考试</button></h3>
                            </div>
                        </li>
...
<div id='dia' style="display: none;">
    <div >
        <div id="text_box" id="create_Area" action="${pageContext.request.contextPath}/work/insertExam">
