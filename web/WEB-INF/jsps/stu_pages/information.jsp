...
<script>
    $(document).ready(function () {
        ...
        function appendCourse(context, time) {
            var courseContainer = $("#informContainer");
        ...
        var Informs = sliceLong(LongStr);
        var i = 0;
        for (i = 0; i < Informs.length; i++) {
            appendCourse(Informs[i][1].slice(1,-1), Informs[i][2].slice(1,-2));
        }
    })
</script>
<!--头部-->
